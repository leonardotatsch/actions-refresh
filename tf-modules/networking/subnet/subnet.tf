resource "azurerm_subnet" "subnet" {
  ...
  private_endpoint_network_policies             = var.END_NETWORK_POLICIES_ENABLED
...
## In order to deploy a Private Link Endpoint on a given subnet, you must set the private_endpoint_network_policies attribute to false.
